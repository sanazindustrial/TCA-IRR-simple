...
export const MODULE_DEFINITIONS = {
    tca: { name: 'TCA Scorecard', description: 'Core technology capability assessment', version: '2.1' },
    risk: { name: 'Risk Flags', description: 'Risk analysis across 14 domains', version: '1.8' },
    macro: { name: 'Macro Trend Alignment', description: 'PESTEL analysis and trend scores', version: '1.2' },
    benchmark: { name: 'Benchmark Comparison', description: 'Performance vs. sector averages', version: '1.5' },
    growth: { name: 'Growth Classifier', description: 'Predict growth potential', version: '3.1' },
    gap: { name: 'Gap Analysis', description: 'Identify performance gaps', version: '2.0' },
    founderFit: { name: 'Founder Fit Analysis', description: 'Investor matching & readiness', version: '1.0' },
    team: { name: 'Team Assessment', description: 'Analyze founder and team strength', version: '1.4' },
    strategicFit: { name: 'Strategic Fit Matrix', description: 'Align with strategic pathways', version: '1.1' },
    financial: { name: 'Financial Analysis', description: 'Revenue model, burn rate, and financial health', version: '1.0' },
    economic: { name: 'Economic Analysis', description: 'Market size, pricing, and economic viability', version: '1.0' },
    social: { name: 'Social Impact Analysis', description: 'ESG factors and social impact metrics', version: '1.0' },
    marketing: { name: 'Marketing Analysis', description: 'GTM strategy, brand positioning, and channels', version: '1.0' },
    environmental: { name: 'Environmental Analysis', description: 'Environmental compliance and sustainability', version: '1.0' },
    funder: { name: 'Funder Fit Analysis', description: 'Investor alignment and funding readiness', version: '1.0' },
    strategic: { name: 'Strategic Analysis', description: 'Competitive positioning and strategic roadmap', version: '1.0' },
    analyst: { name: 'Analyst Review', description: 'Manual analyst input, NLP analysis, and AI deviation review', version: '1.0' },
};
