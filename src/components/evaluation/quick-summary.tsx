...
export function QuickSummary({ companyName, sector, stage, valuation, reportVersion }: QuickSummaryProps = {}) {
  return (
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-x-8 gap-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className="font-bold text-lg">{sector || '—'}</p>
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <p className="font-bold text-lg">{valuation || '—'}</p>
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <p className="font-bold text-lg">{reportVersion || '1.0.0'}</p>
          </div>
        </div>
      </div>
    </DashboardCard>
