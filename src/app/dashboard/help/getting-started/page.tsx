        ...
        <div className="container mx-auto p-4 md:p-8">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>This guide will walk you through the process of running your first company analysis.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-8">
                    <Step
                        num="1"
                        title="Navigate to Company Analysis"
                        description='From the main dashboard, click the "Company Analysis" or "Run New Analysis" button. This will take you to the Analysis Setup page where you will begin the process.'
                    />
                    <Step
                        num="2"
