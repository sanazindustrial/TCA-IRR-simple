            ...
            <Card>
                ...
                <CardContent className="space-y-8">
                    ...
                    <Step
                        ...
                        description="You can create multiple versions of these configurations for different sectors (e.g., a 'Tech' setup and a 'MedTech' setup). The appropriate configuration is selected when starting a new analysis."
