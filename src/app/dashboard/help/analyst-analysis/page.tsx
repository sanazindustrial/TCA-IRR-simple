...
export default function AnalystAnalysisGuidePage() {
  return (
    <div className="container mx-auto p-4 md:p-8">
      <header className="mb-8">
        ...
        <h1 className="text-4xl md:text-5xl font-bold font-headline text-primary tracking-tight">
          Guide: Analyst Analysis & Manual Input
        </h1>
        <p className="mt-4 text-lg text-muted-foreground max-w-3xl">
          Learn how to add qualitative insights and run deeper analysis as a Analyst.
        </p>
      </header>
      ...
      <Card>
        <CardHeader>
            ...
            <CardDescription>This guide explains how to use the "Analyst Analysis" page to enrich the AI's evaluation.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
            <Step
                num="1"
                title="Start a Review from the Hub"
                description="Navigate to the 'Analyst Hub' from the sidebar. Find a 'Pending Review' assignment and click 'Start Review'. This will take you to the main Analyst Analysis page."
                link={{ href: "/dashboard/Analyst", text: "Go to Analyst Hub" }}
            />
            <Step
                num="2"
            ...
            <Step
                ...
                description="First, save your qualitative inputs using the 'Save Analyst Analysis' button. Then, click 'Run Full Analyst Analysis'. This triggers the deep NLP analysis on your comments and generates the final comparison charts."
            />
             <Step
                num="6"
