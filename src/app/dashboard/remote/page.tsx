...
const initialPages = [
  { id: 'eval', name: 'Upload & Evaluate', path: '/upload', description: 'Document upload and AI evaluation interface', status: 'iFrame' as 'iFrame' | 'Widget', enabled: true, dims: '1000w x 800h', theme: 'light', auth: true, rate: '50/hour', roles: ['admin', 'analyst', 'user'] },
  { id: 'dash', name: 'User Dashboard', path: '/dashboard', description: 'User dashboard with analytics and reports', status: 'iFrame' as 'iFrame' | 'Widget', enabled: true, dims: '1200w x 800h', theme: 'auto', auth: true, rate: '100/hour', roles: ['admin', 'analyst'] },
  ...
  { id: 'submit', name: 'Submit Request to Admin', path: '/submit-request', description: 'User request submission form', status: 'Widget' as 'iFrame' | 'Widget', enabled: true, dims: '500w x 400h', theme: 'auto', auth: false, rate: '75/hour', roles: ['user', 'analyst'] },
]
