...
export default function ModuleControlDeck() {
    ...
    // Handle slug parameter - redirect to appropriate analysis module
    useEffect(() => {
        if (params?.slug) {
            const slug = params.slug as string;
            setIsRedirecting(true);
            // Use replace for safer navigation (prevents back button issues)
            router.replace(`/analysis/modules/${slug}`);
        }
    }, [params, router]);
                ...
                <div className="flex items-center justify-center min-h-[400px]">
                    <Card className="w-full max-w-md">
                        <CardHeader className="text-center">
                            ...
                            <CardDescription>Redirecting to module configuration</CardDescription>
                        </CardHeader>
