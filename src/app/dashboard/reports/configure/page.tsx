...
const defaultDdSections = [
    { id: 'executive-summary', title: "1. Executive Summary", active: true, description: "Overall investment recommendation, key highlights, and company overview" },
    { id: 'tca-scorecard', title: "2. TCA Scorecard", active: true, description: "Composite score with category breakdown" },
    { id: 'tca-summary-card', title: "3. TCA Summary Card", active: true, description: "Condensed TCA overview with top strengths and concerns" },
    { id: 'tca-ai-table', title: "4. TCA AI Analysis Table – 12 Categories", active: true, description: "Comprehensive AI-generated analysis across all 12 TCA evaluation categories" },
    { id: 'tca-interpretation-summary', title: "5. TCA AI Interpretation Summary", active: true, description: "AI interpretation and key insights from the TCA analysis" },
    { id: 'weighted-score-breakdown', title: "6. Weighted Score Breakdown", active: true, description: "Detailed weighted scores by evaluation category with methodology explanation" },
    { id: 'risk-flags', title: "7. Risk Flags & Mitigation", active: true, description: "Full risk flags with mitigation strategies by domain" },
    { id: 'risk-flag-summary-table', title: "8. Risk Flag Summary Table (14 Domains)", active: true, description: "Complete risk flag analysis across all 14 risk domains with severity ratings" },
    { id: 'flag-analysis-narrative', title: "9. Flag Analysis Narrative", active: true, description: "In-depth narrative analysis of identified risk flags" },
    { id: 'gap-analysis', title: "10. Gap Analysis", active: true, description: "Performance gaps heatmap and priority improvement roadmap" },
    { id: 'macro-trend-alignment', title: "11. Macro Trend + Benchmark Comparison", active: true, description: "PESTEL analysis and market trend alignment signals" },
    { id: 'benchmark-comparison', title: "12. Benchmark Comparison", active: true, description: "Performance vs industry benchmark averages and percentile rank" },
    { id: 'competitive-landscape', title: "13. Competitive Landscape", active: true, description: "Market positioning, competitor analysis, and differentiation" },
    { id: 'growth-classifier', title: "14. Growth Classifier Matrix", active: true, description: "Growth trajectory classification with supporting metrics and projections" },
    { id: 'financials-burn-rate', title: "15. Financials & Burn Rate", active: true, description: "Financial statements, runway analysis, unit economics, and projections" },
    { id: 'gtm-strategy', title: "16. Go-to-Market & Commercial Strategy", active: true, description: "Sales strategy, distribution channels, pricing, and market penetration plan" },
    { id: 'funder-fit-analysis', title: "17. Funder Fit Analysis", active: true, description: "Investor matching, funding readiness score, and recommended round" },
    { id: 'team-assessment', title: "18. Founder Fit + Team Analysis", active: true, description: "Founder background, team composition, capabilities, and identified gaps" },
    { id: 'strategic-fit-matrix', title: "19. Strategic Fit Matrix", active: true, description: "Alignment assessment with investor thesis, portfolio fit, and strategic pathways" },
    { id: 'ip-technology-review', title: "20. IP & Technology Review", active: true, description: "Technology stack, patents, trade secrets, and technical defensibility" },
    { id: 'regulatory-compliance', title: "21. Regulatory / Compliance Review", active: true, description: "Regulatory requirements, compliance status, and risk mitigation plans" },
    { id: 'exit-strategy-roadmap', title: "22. Exit Strategy Roadmap", active: true, description: "Exit opportunities, potential acquirers, IPO readiness, and timeline" },
    { id: 'financial-analysis', title: "23. Financial Analysis", active: true, description: "Revenue model, unit economics, burn rate, projections, and funding requirements" },
    { id: 'economic-analysis', title: "24. Economic Analysis", active: true, description: "Market size, industry structure, pricing power, and macro-economic indicators" },
    { id: 'social-analysis', title: "25. Social Impact Analysis", active: true, description: "ESG scoring, social impact, demographic fit, and stakeholder trust" },
    { id: 'marketing-analysis', title: "26. Marketing Analysis", active: true, description: "Brand positioning, digital presence, spend efficiency, and GTM execution" },
    { id: 'environmental-analysis', title: "27. Environmental Analysis", active: true, description: "Environmental footprint, climate risk, certifications, and ESG alignment" },
    { id: 'funder-analysis', title: "28. Funder Fit Analysis (AI)", active: true, description: "Investor alignment score, stage readiness, deck quality, and network strength" },
    { id: 'strategic-analysis', title: "29. Strategic Analysis (AI)", active: true, description: "Competitive positioning, moat strength, roadmap clarity, and partnership potential" },
    { id: 'term-sheet-trigger', title: "30. Term Sheet Trigger Analysis", active: true, description: "Investment triggers, terms considerations, and deal structure recommendations" },
    { id: 'ceo-questions', title: "31. CEO Questions", active: true, description: "Strategic questions for the CEO and leadership team" },
    { id: 'consistency-check', title: "32. Consistency Check", active: true, description: "Cross-validation of data consistency across all analysis modules" },
    { id: 'analyst-comments', title: "33. Analyst Comments", active: true, description: "Human analyst review, sentiment scoring, and qualitative assessments" },
    { id: 'analyst-ai-deviation', title: "34. Analyst–AI Score Deviation", active: true, description: "Analysis of variance between AI scores and human reviewer ratings" },
    { id: 'final-recommendation', title: "35. Final Recommendation", active: true, description: "Investment decision, recommended terms, and conditions for proceeding" },
    { id: 'appendix', title: "36. Appendix: DD Artifacts & Config Snapshot", active: true, description: "Supporting documents, data sources, and analysis configuration snapshot" },
];
