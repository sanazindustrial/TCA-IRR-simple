...
import { DocumentSubmission } from '@/components/analysis/document-submission';
...
import { Shield, User, Timer } from 'lucide-react';
...
export default function AnalysisPage({ runAnalysis }: AnalysisPageProps) {
  ...
  const handleRunAnalysis = async () => {
    ...
    try {
      const comprehensiveData = await runAnalysis(framework);
  ...
  return (
    ...
    >
        ...
        <div className="container mx-auto p-4 md:p-8">
            ...
            {isLoading ? <Loading /> : <AnalysisSetup />}
        </div>
        </main>
    </EvaluationProvider>
  );
