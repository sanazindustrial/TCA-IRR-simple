...
Overall Risk Rating: ${j>=8.5?"GREEN":j>=7?"YELLOW":"RED"}`},financial_analysis:{title:"Financial Analysis",content:`**Financial Module Score: ${c("financial")}/10**

${d("financial")||`Financial analysis for ${k} reveals ${j>=7?"solid":"developing"} revenue foundations. Key financial indicators assessed include revenue growth trajectory, burn rate, unit economics, and path to profitability.`}

**Key Financial Indicators:**
• Revenue model viability assessed
• Unit economics reviewed
• Burn rate and runway analyzed
• Capital efficiency evaluated`},"financial-analysis":{title:"Financial Analysis",content:`**Financial Module Score: ${c("financial")}/10**

${d("financial")||"Evaluates scalability, capital efficiency, forecast realism, and funding discipline."}

**Framework Weights:**
• Revenue Model 30%
• Unit Economics 30%
• Projections 20%
• Funding Requirements 20%`},"economic-analysis":{title:"Economic Analysis",content:`**Economic Module Score: ${c("economic")}/10**

${d("economic")||"Assesses macro durability and recession resilience."}

**Framework Weights:**
• Industry Structure 30%
• Pricing Power 25%
• Macro Indicators 25%
• Cycle Resilience 20%`},"social-analysis":{title:"Social Analysis",content:`**Social Module Score: ${c("social")}/10**

${d("social")||"Measures social trust, adoption readiness, and stakeholder acceptance."}

**Framework Weights:**
• Social Impact 30%
• Demographic Fit 25%
• Cultural Adoption 25%
• Stakeholder Trust 20%`},"marketing-analysis":{title:"Marketing Analysis",content:`**Marketing Module Score: ${c("marketing")}/10**

${d("marketing")||"Evaluates positioning, demand generation quality, and GTM execution."}

**Framework Weights:**
• Positioning 25%
• Digital Presence 20%
• Spend Efficiency 30%
• GTM Execution 25%`},"environmental-analysis":{title:"Environmental Analysis",content:`**Environmental Module Score: ${c("environmental")}/10**

${d("environmental")||"Assesses environmental sustainability, climate risk, and ESG alignment."}

**Framework Weights:**
• Environmental Impact 30%
• Climate Risk 25%
• Certification 15%
• ESG Alignment 30%`},risk_assessment:{title:"Risk Assessment",content:`**Risk Module Score: ${c("risk")}/10**
...
**Worst Case (${i?.worst_case?.score??"N/A"}/10):** ${i?.worst_case?.narrative??"Challenging market environment and execution risks materialize."}`},investment_recommendation:{title:"Investment Recommendation",content:g?.recommendation??`Based on the TCA-IRR analysis, the composite score of ${j.toFixed(1)}/10 supports a **${j>=8.5?"Advanced Screening / DD":j>=7?"Prescreening":j>=5?"Early Stage":"Reject"}** recommendation.
...
• Mission-founder alignment`},"founder-fit":{title:"Founder Fit Assessment",content:`**Founder Fit Score: ${c("founderFit")}/10**

${d("founderFit")||`Founder fit analysis for the ${k} leadership team.`}`},gap_analysis:{title:"Gap Analysis",content:`**Gap Analysis Score: ${c("gap")}/10**
...
• Board governance
• Cap table clarity`},"funder-readiness":{title:"Funder Readiness Assessment",content:`**Funder Readiness Score: ${c("funder")}/10**

${d("funder")||`Assessment of ${k}'s readiness for investor engagement.`}`},"strategic-fit":{title:"Strategic Fit Matrix",content:`**Strategic Fit Score: ${c("strategicFit")}/10**

${d("strategicFit")||`Strategic fit assessment for ${k} against investor mandate and portfolio pathways.`}`},simulation_results:{title:"Simulation Results",content:`**Simulation Score: ${c("simulation")}/10**
