...
console.log('Clearing stored analysis data...'); // Clear localStorage

if (typeof localStorage !== 'undefined') {
  localStorage.removeItem('analysisResult');
  localStorage.removeItem('analysisData');
  localStorage.removeItem('tcaData');
  localStorage.removeItem('reportData'); // Clear any other analysis-related data
...
if (typeof sessionStorage !== 'undefined') {
  ...
  sessionStorage.removeItem('reportData'); // Clear any other analysis-related data
...
console.log('You should now see all 12 TCA categories.'); // Show instructions
